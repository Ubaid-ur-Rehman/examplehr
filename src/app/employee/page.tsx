    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-semibold text-zinc-950">Your Balances</h2>
        </div>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-zinc-950">Request Time Off</h2>
        <RequestForm
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-zinc-950">Your Requests</h2>
        <RequestList
